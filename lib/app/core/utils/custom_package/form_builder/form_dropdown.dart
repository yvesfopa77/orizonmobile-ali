...
class CustomFormBuilderDropdown<T> extends FormBuilderFieldDecoration<T> {
  ...
  @override
  FormBuilderFieldDecorationState<CustomFormBuilderDropdown<T>, T>
      createState() => _FormBuilderDropdownState<T>();
}

class _FormBuilderDropdownState<T>
    extends FormBuilderFieldDecorationState<CustomFormBuilderDropdown<T>, T> {
  @override
  void didUpdateWidget(covariant CustomFormBuilderDropdown<T> oldWidget) {
