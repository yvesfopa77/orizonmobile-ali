...
class CustomFormBuilderPhoneField extends FormBuilderFieldDecoration<String> {
  ...
  final Function(String?)? numberUpdateChanges;
          ...
          builder: (FormFieldState<String?> field) {
            ...
            return Column(
              ...
              children: [
                ...
                10.verticalSpace,
                InputDecorator(
                  decoration: state.decoration.copyWith(isCollapsed: true),
                  child: Row(
                    children: <Widget>[
                      GestureDetector(
                        onTap: state.enabled
                            ...
                            : Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    '+${state._selectedDialogCountry.phoneCode} ',
                                    style:
                                        Theme.of(state.context).textTheme.titleMedium!.merge(style),
                                  ),
                                ],
                              ),
                      ),
                      Expanded(
                        child: TextField(
                          ...
                          onChanged: (value) {
                            numberUpdateChanges?.call(value);
  ...
  @override
  FormBuilderFieldDecorationState<CustomFormBuilderPhoneField, String> createState() =>
...
class _FormBuilderPhoneFieldState
    extends FormBuilderFieldDecorationState<CustomFormBuilderPhoneField, String>
  ...
  Future<void> _parsePhone({String? newPhone}) async {
    ...
    if (phone.isNotEmpty) {
      try {
        ...
        setState(() {
          _selectedDialogCountry =
              CountryPickerUtils.getCountryByIsoCode(parseResult.isoCode.toJson());
        });
