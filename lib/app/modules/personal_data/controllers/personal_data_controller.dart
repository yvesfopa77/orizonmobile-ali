    ...
    if (formState.validate()) {
      onboardingDataModel = onboardingDataModel.copyWith(
        ...
        birthdate: DateFormat('yyyy-MM-dd')
            .format(formState.fields[AppConstants.birth_date_field]!.value),
      ...
      if (response.statusCode == 200) {
        Get.toNamed(Routes.PROFILE_ACTIVITY);
      } else {
  ...
  void populateAddressFromLocation() async {
    ...
    if (currentLocation != null) {
      ...
      if (address.address != null) {
        formKey.currentState!.fields[AppConstants.address_field]!
            .didChange(address.address);
      }
      if (address.placemark != null &&
          address.placemark!.locality!.isNotEmpty) {
