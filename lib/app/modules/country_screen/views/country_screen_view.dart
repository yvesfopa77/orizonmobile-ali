                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomFormBuilderTextField(
                      ...
                      hintText: 'Select country',
                      validator:
                          FormBuilderValidators.required(errorText: "Orgin country is required"),
                    ),
                    Row(
                      children: [
                        Checkbox(
                    ...
                    20.verticalSpace,
                    Obx(
                      () => controller.SelectedOrigincountry?.value == null
                          ? const SizedBox.shrink()
                          : CountryTile(
                              country: controller.SelectedOrigincountry!.value,
                    ...
                    SizedBox(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(text: "Read ", style: AppTextStyle.s11.regular.grey),
                            TextSpan(
                                text: "Terms & Conditions", style: AppTextStyle.s11.regular.black),
                            TextSpan(
                                text: " of your Country", style: AppTextStyle.s11.regular.grey),
                          ],
                        ),
                      ),
                    ),
...
class CustomCheck extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: alignToEnd ? MainAxisAlignment.end : MainAxisAlignment.start,
      children: [
        Container(
          width: 18.r,
          height: 18.r,
