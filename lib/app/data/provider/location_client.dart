...
class LocationClient {
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        ErrorDialogs.errorbottomSheet(
            text: "No address found for the location");
      }
    } catch (e) {
      return LocationAddress();
    }
  ...
  static Future<CountryDetail?> countryFromUserLocation() async {
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        return CountryDetail(name: place.country, iso: place.isoCountryCode);
      }
      return null;
    } catch (e) {
      return null;
